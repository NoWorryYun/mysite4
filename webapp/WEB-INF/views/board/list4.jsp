					...
					<div id="list">
						...
						<div id="paging">
							<ul>
								<c:if test="${pMap.prev}">
									<li><a
										href="${pageContext.request.contextPath }/board/list4?crtPage=${pMap.startPageBtnNo-1}">◀</a></li>
								</c:if>
								...
								<c:forEach begin="${pMap.startPageBtnNo}"
									...
									<c:choose>
										<c:when test="${param.crtPage==page}">
											<li class="active"><a
												href="${pageContext.request.contextPath }/board/list4?crtPage=${page}">${page}</a></li>
										</c:when>
										<c:otherwise>
											<li><a
												href="${pageContext.request.contextPath }/board/list4?crtPage=${page}">${page}</a></li>
								...
								<c:if test="${pMap.next}">
									<li><a
										href="${pageContext.request.contextPath }/board/list4?crtPage=${pMap.endPageBtnNo+1}">▶</a></li>
								</c:if>
							</ul>
